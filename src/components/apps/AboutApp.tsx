import { Code, Database, Globe, Award, Calendar, MapPin } from 'lucide-react';
...
const AboutApp = () => {
  const experiences = [
    {
      ...
      description: 'Building scalable web applications and improving data handling performance by 20%.',
  ...
  const projects = [
    {
      name: 'Lumina AI',
      description: 'AI-powered chatbot with React Native & Node.js using Gemini API',
    ...
    {
      name: 'Quizaki',
      description: 'Real-time quiz platform with admin panel and bot protection',
    ...
    <div className="h-full overflow-auto bg-gradient-to-br from-gray-900 to-gray-800 text-white">
      <div className="p-8">
        ...
        <div className="text-center mb-8">
          <div className="w-24 h-24 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full mx-auto mb-4 flex items-center justify-center text-2xl font-bold">
            AS
          </div>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-300 leading-relaxed">
            ...
            I love building scalable applications and exploring the intersection of web development and AI/ML. 
            Currently pursuing my Bachelor's in Computer Science while actively contributing to innovative projects 
          ...
          <div className="space-y-4">
            {experiences.map((exp, index) => (
              <div key={index} className="glass p-6 rounded-lg">
                ...
                <div className="text-gray-300 mb-2">{exp.company} • {exp.location}</div>
            ...
            {achievements.map((achievement, index) => (
              <div key={index} className="glass p-4 rounded-lg flex items-center">
                ...
                <div className="ml-3">
                  ...
                  <p className="text-gray-400 text-sm">{achievement.event} • {achievement.date}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <section>
          ...
          <div className="glass p-6 rounded-lg">
            ...
            <p className="text-sm text-gray-500">Oct 2023 - Oct 2027 (Expected)</p>
          </div>
        </section>
      </div>
    </div>
