              ...
              <section>
                ...
                <div className="glass p-4 rounded-lg">
                  ...
                  <p className="text-sm text-gray-400 mt-2">
                    This will reset wallpaper, theme, and all customizations to
                    default values.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="glass p-6 rounded-lg">
                  <h3 className="text-lg font-semibold mb-3">
                    Aditya Srivastava OS
                  </h3>
                  <p className="text-gray-100 mb-4">
                    An interactive portfolio operating system that showcases my
                    work and skills through a fully functional desktop
                    environment. This project demonstrates modern web
                    development techniques and creative UI/UX design.
                  </p>
              ...
              <section>
                ...
                <div className="glass p-6 rounded-lg">
                  <ul className="space-y-2 text-gray-300">
                    <li>
                      • Interactive desktop environment with window management
                    </li>
